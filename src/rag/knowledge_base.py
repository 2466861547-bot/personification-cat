...
DEFAULT_KNOWLEDGE = [
    ...
    KnowledgeEntry("cat", "通用", "curious",
        "轻柔短促的咕咕声(trill)，伴随头部偏转和耳朵朝向声源",
        "猫咪对某物感到好奇，正在探索和观察",
        "看到新玩具、闻到新气味、听到不熟悉的声音",
        "允许猫咪安全探索，不要打断，可提供新玩具满足好奇心"),
    KnowledgeEntry("cat", "通用", "lonely",
        "低沉长喵叫，间隔较长，可能在门口或窗边来回走动",
        "猫咪感到孤独，希望主人陪伴",
        "主人长时间不在家、独处超过6小时",
        "增加每日陪伴时间，可考虑养第二只猫或提供自动逗猫设备"),
    KnowledgeEntry("cat", "通用", "anxious",
        "反复的低频呜咽或过度舔毛伴随断续喵叫",
        "猫咪感到焦虑不安，环境压力导致行为异常",
        "搬家、新宠物到家、装修噪音、日常规律被打破",
        "提供安静隐蔽空间，使用费洛蒙扩散器，保持日常规律稳定"),
    KnowledgeEntry("cat", "通用", "excited",
        "快速连续的短喵叫，伴随竖尾、踩奶、眼睛放大",
        "猫咪极度兴奋，通常因为预期到好事发生",
        "看到猫粮袋、听到罐头打开声、看到逗猫棒",
        "满足猫咪的期待，适度互动或喂食，避免过度刺激"),
    KnowledgeEntry("cat", "通用", "frustrated",
        "低沉短促的喷气声(spkitty)或不满意的重音喵叫",
        "猫咪感到挫败或不满，期待落空后表达不满",
        "想要开门但被拒绝、想抓虫子但够不着、逗猫棒突然收起",
        "理解猫咪的挫败感，适当满足或转移注意力到其他活动"),
    KnowledgeEntry("cat", "通用", "relaxed",
        "极少发声，偶尔极轻柔的呼噜声，呼吸平稳",
        "猫咪处于完全放松状态，对环境高度信任",
        "在阳光下晒太阳、在主人腿上打盹、熟悉的环境中",
        "享受这安静时刻，轻柔抚摸即可，不要打扰猫咪休息"),
    KnowledgeEntry("cat", "通用", "territorial",
        "持续的中低频嚎叫，伴随巡视和尿液标记行为",
        "猫咪宣示领地主权，警告其他猫不要靠近",
        "新猫到家、窗外有流浪猫、家中引入新家具",
        "提供独立空间和资源(猫砂盆、食碗)，逐步引导新猫融入"),
    KnowledgeEntry("cat", "通用", "greeting",
        "轻快的颤音(trill)或短促欢快的喵叫，伴随竖尾蹭腿",
        "猫咪在向主人打招呼，表示欢迎和亲近",
        "主人回家、早上起床、长时间未见后重聚",
        "回应猫咪，蹲下与它平视互动，轻声说话和抚摸"),
    KnowledgeEntry("cat", "通用", "confused",
        "不规则的间歇性喵叫，声音忽高忽低，伴随头部反复偏转",
        "猫咪对环境变化感到困惑，不确定如何反应",
        "家具重新摆放、新猫窝位置变化、日常路线被阻挡",
        "给猫咪时间适应变化，保持耐心，可引导它探索新环境"),
    KnowledgeEntry("cat", "通用", "jealous",
        "插嘴式的短喵叫，强行挤入主人与其他宠物之间",
        "猫咪感到嫉妒，争抢主人的注意力和关爱",
        "主人抚摸其他宠物、新宠物到家、主人关注手机而非猫咪",
        "公平分配注意力，给每只猫独立陪伴时间，不要在猫面前偏心"),
    ...
    KnowledgeEntry("dog", "通用", "pain",
        ...
        "运动后、跳跃后、老年犬关节问题",
        "检查受伤部位，避免触碰痛处，联系兽医"),
    KnowledgeEntry("dog", "通用", "curious",
        "低沉的呜呜声，伴随头部偏转、耳朵竖起、缓慢靠近目标",
        "狗狗对某物感到好奇，正在谨慎探索",
        "遇到新玩具、闻到新气味、看到不熟悉的物体",
        "允许狗狗安全嗅闻探索，不要拉扯牵引绳，给予探索时间"),
    KnowledgeEntry("dog", "通用", "lonely",
        "长而缓慢的哀嚎，伴随趴在门口、不愿活动",
        "狗狗感到孤独，想念主人或同伴",
        "主人长时间外出、独处超过4小时、同伴离世或分离",
        "增加陪伴时间，留有主人气味的衣物，提供益智玩具"),
    KnowledgeEntry("dog", "通用", "anxious",
        "持续的呜咽声，伴随舔嘴唇、打哈欠、踱步",
        "狗狗感到焦虑不安，环境变化或分离导致",
        "主人出门、搬家、新成员加入、雷雨天",
        "进行脱敏训练，可使用安定背心，严重时咨询兽医行为师"),
    KnowledgeEntry("dog", "通用", "excited",
        "快速连续的汪汪叫，伴随原地跳跃、摇尾、全身扭动",
        "狗狗极度兴奋，期待即将发生的好事",
        "主人拿牵引绳、看到球、到公园门口",
        "引导坐下冷静后再进行活动，避免过度兴奋导致冲动行为"),
    KnowledgeEntry("dog", "通用", "frustrated",
        "短促低沉的呜咽转为尖锐叫声，伴随抓挠门或扒地",
        "狗狗感到挫败，想做的事被阻挡",
        "看到其他狗但被牵引绳限制、想追但够不着",
        "理解狗狗的挫败感，引导替代行为，训练耐心等待"),
    KnowledgeEntry("dog", "通用", "relaxed",
        "偶尔轻柔的叹气声，身体侧躺，呼吸平稳缓慢",
        "狗狗处于完全放松状态，对环境高度信任",
        "在家中休息、主人陪伴看书、饭后小憩",
        "享受安静时光，轻柔抚摸即可，不要突然打扰"),
    KnowledgeEntry("dog", "通用", "territorial",
        "深沉连续的吠叫，伴随身体前倾、竖毛、尾僵直",
        "狗狗宣示领地，警告入侵者离开",
        "陌生人接近家门、其他狗在自家门口经过",
        "安抚狗狗，确认安全后引导停止吠叫，避免奖励领地行为"),
    KnowledgeEntry("dog", "通用", "greeting",
        "轻快短促的汪叫1-2声，伴随大幅摇尾、跳跃舔脸",
        "狗狗在向主人或熟人打招呼，表达喜悦",
        "主人回家、接主人起床、遇到熟悉的狗朋友",
        "热情回应狗狗，蹲下与它互动，适当抚摸和语言鼓励"),
    KnowledgeEntry("dog", "通用", "confused",
        "间歇性的歪头呜呜声，声音低沉犹豫，伴随头部反复偏转",
        "狗狗对指令或环境感到困惑，不确定主人意图",
        "新指令、手势不清晰、环境变化后找不到位置",
        "清晰重复指令，引导示范行为，保持耐心不要强迫"),
    KnowledgeEntry("dog", "通用", "jealous",
        "插嘴式吠叫，强行挤入主人与其他宠物之间，伴随推搡",
        "狗狗感到嫉妒，争抢主人的注意力和关爱",
        "主人抚摸其他狗、新宠物到家、主人抱婴儿",
        "公平分配注意力，分别给每只狗独立陪伴时间，训练等待"),
